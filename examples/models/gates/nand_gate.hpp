...
/// @brief A simple NAND gate implementation using simcore.
...
class NandGate : public simcore::module_t
{
public:
    ...
    NandGate(const std::string &_name, simcore::module_t *_parent = nullptr)
